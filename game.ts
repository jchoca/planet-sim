...
class Game {
    ...
    createScene() : void {
        ...
        const camera = new BABYLON.ArcRotateCamera('camera1', 0, 0, 0, new BABYLON.Vector3(this._orbitRadius, 0, this._orbitRadius), this._scene);
    ...
    showAxis(size: number) {
        const makeTextPlane = (text, color, size) => {
            const dynamicTexture = new BABYLON.DynamicTexture("DynamicTexture", 50, this._scene, true);
